     ...
     listSensor  = async () => {
          try {
               const list = await mysql.query(
                    'SELECT * FROM alat_2_alkohol_ppm',
                    []
               )
     ...
     addSensor = async (body) => {
          try {
               ...
               const add = await mysql.query(
                    "INSERT INTO alat_2_alkohol_ppm(sensor1_ch4, sensor1_co, sensor1_h2, sensor2_co, sensor3_ch4,  sensor4_nh3, sensor5_h2, sensor6_co, sensor6_h2, sensor6_c4h10) VALUES (?,?,?,?,?,?,?,?,?,?)",
