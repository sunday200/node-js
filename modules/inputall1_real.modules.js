     ...
     listSensor  = async () => {
          try {
               const list = await mysql.query(
                    'SELECT * FROM tangkap_sensor_all_1',
                    []
               )
     ...
     addSensor = async (body) => {
          try {
               ...
               const add = await mysql.query(
                    "INSERT INTO tangkap_sensor_all_1(sensor1_adc, sensor2_adc, sensor3_adc, sensor4_adc, sensor5_adc, sensor6_adc, sensor1_res, sensor2_res, sensor3_res, sensor4_res, sensor5_res, sensor6_res, sensor1_ch4, sensor1_co, sensor1_h2, sensor2_co, sensor3_ch4,  sensor4_nh3, sensor5_h2, sensor6_co, sensor6_h2, sensor6_c4h10) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)",
